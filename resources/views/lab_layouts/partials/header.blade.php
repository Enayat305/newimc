...
<!-- Main Header -->
  <header class="main-header no-print">
    <a href="{{route('lab_home')}}" class="logo">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      @if(Module::has('Superadmin'))
        @includeIf('superadmin::lab_layouts.partials.active_subscription')
      @endif
      ...
      <div class="navbar-custom-menu">
        ...
        <button id="btnCalculator" title="@lang('lang_v1.calculator')" type="button" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10 popover-default" data-toggle="popover" data-trigger="click" data-content='@include("lab_layouts.partials.calculator")' data-html="true" data-placement="bottom">
            <strong><i class="fa fa-calculator fa-lg" aria-hidden="true"></i></strong>
        </button>
        
        @if($request->segment(1) == 'los')
        ...
        @can('lab_sell.create')
          <a href="{{action('Lab\SellPosController@create')}}" title="POS" data-toggle="tooltip" data-placement="bottom" class="btn btn-success btn-flat pull-left m-8 hidden-xs btn-sm mt-10">
        ...
        <ul class="nav navbar-nav">
          @include('lab_layouts.partials.header-notifications')
          <!-- User Account Menu -->
