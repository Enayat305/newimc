...
<div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="col-sm-12 col-xs-12">
        <div class="table-responsive">
          @include('Laboratory/lab_sale_pos.partials.sale_line_details')
        </div>
      </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table bg-gray">
            <tr>
              <th>{{ __('sale.total') }}: </th>
              <td></td>
              <td><span class="display_currency pull-right" data-currency_symbol="true">{{ $sell->total_before_tax + $sell->discount_amount}}</span></td>
            </tr>
            <tr>
  ...
  <div class="modal-footer">
    <a href="#" class="print-invoice btn btn-primary" data-href="{{route('labsell.printInvoice', [$sell->id])}}"><i class="fa fa-print" aria-hidden="true"></i> @lang("messages.print")</a>
