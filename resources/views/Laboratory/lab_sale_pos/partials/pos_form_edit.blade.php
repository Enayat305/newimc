	...
	<div class="col-md-3">
		<div class="form-group" style="width: 100% !important">
			<div class="input-group">
				...
				{!! Form::select('doctor_id', $doctor, $transaction->ref_by, ['class' => 'form-control select2','style' => 'width:100%', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'doctor_dropdown']); !!}
	...
	<div class="col-md-3">
		<div class="form-group" style="width: 100% !important">
			<div class="input-group">
				...
				{!! Form::select('spicemen', ['Taking_In_Lab'=>'Taking In Lab','Brought_To_Light'=>'Brought to light'],$transaction->spicemen, ['class' => 'form-control select2','style' => 'width:100%', 'required']); !!}
	...
	<div class="col-md-3">
		<div class="form-group">
			<div class="input-group">
				...
				{!! Form::text('search_product', null, ['class' => 'form-control mousetrap', 'id' => 'search_product', 'placeholder' => __('Enter Test Name Or Code'),
				'autofocus' => true,
				]); !!}
				<span class="input-group-btn">
	...
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			...
			<tbody>
				...
				@include('Laboratory/lab_sale_pos.edit_product_row')
			@endforeach
			</tbody>
		</table>
	</div>
