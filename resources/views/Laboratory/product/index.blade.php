    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3" id="location_filter">
            <div class="form-group">
                ...
                {!! Form::select('location_id', $business_locations, 2, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
            </div>
        </div>
        <div class="col-md-3">
            <br>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        @can('lab_product.create')
                            <a class="btn btn-primary pull-right" href="{{action('Lab\ProductController@create')}}">
                                        <i class="fa fa-plus"></i> @lang('messages.add')</a>
                            <br><br>
                        @endcan
                        @include('Laboratory/product.partials.product_list')
                    </div>
...
@include('Laboratory/product.partials.edit_product_location_modal')
