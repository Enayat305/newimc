...
@endphp
{!! Form::open(['url' => action('Lab\ProductController@store'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <!--custom fields-->
        <div class="clearfix"></div>
        @include('lab_layouts.partials.module_form_part')
      </div>
    @endcomponent
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="form-group col-sm-12" id="product_form_part">
          @include('Laboratory/product.partials.single_product_form_part', ['profit_percent' => $default_profit_percent])
        </div>
