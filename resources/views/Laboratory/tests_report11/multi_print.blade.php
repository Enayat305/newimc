...
.table-responsive{
    ...
    <body>
		...
		<div style="">
		  ...
		  <img class="center-block" src="data:image/png;base64,{{DNS1D::getBarcodePNG($values->report_code, 'C128', 1,40,array(39, 48, 54), true)}}">
		  ...
		  <div class="patient_info"  >
			<table class="meta1"style="border-bottom: solid #eee;text-transform: uppercase;"  >
				...
				<tr>
				   ...
				   <td><span >{{$values->contact->name}}</span></td>
				</tr>
				<tr>
				   <th><span >Age/Sex</span></th>
				   <td><span >{{$values->contact->age.'   /  '.$values->contact->gender}}</span></td>
				</tr>
				<tr>
				   <th><span >Address</span></th>
				   <td><span >{{$values->contact->city}}</span></td>
				</tr>
				<tr>
				   <th><span >Contat No</span></th>
				   <td><span >{{$values->contact->mobile}}</span></td>
				</tr>
				<tr>
				   <th><span >MR #</span></th>
				<td><span >{{$values->contact->contact_id}}</span></td>
				</tr>
				</table>
				<table class="meta" style="border-bottom: solid #eee">
				<tr>
				   <th><span >Reported Dated</span></th>
				   <td><span >{{@format_datetime($values->reported_dated)}}</span></td>
				</tr>
				<tr>
				   <th><span >Receipt Date</span></th>
				   <td><span >{{@format_datetime($values->transaction->transaction_date)}}</span></td>
				</tr>
				<tr>

				   <th><span >Invoice #</span></th>
				   <td><span >{{$values->transaction->invoice_no}}</span></td>
				</tr>
				<tr>
				   <th><span >Specimen</span></th>
				   <td><span >{{$values->transaction->spicemen}}</span></td>
				</tr>
				<tr>
				   <th><span >Ref By</span></th>
				   <td><span> {{$values->doctor->surname.' '.$values->doctor->first_name.' '.$values->doctor->last_name}}</span></td>
				</tr>
