...
{!! Form::hidden('location_id', $sell->location->id, ['id' => 'location_id', 'data-receipt_printer_type' => $sell->location->receipt_printer_type ]); !!}
	...
	{!! Form::open(['url' => action('Lab\SellReturnController@store'), 'method' => 'post', 'id' => 'sell_return_form' ]) !!}
	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
				...
				<div class="col-sm-12"><table class="table bg-gray">
					<tr class="bg-green">
					<th>#</th>
					<th>{{ __('Test Name') }}</th>
...
{{-- <script src="{{ asset('js/labsell_return.js?v=' . $asset_v) }}"></script> --}}
