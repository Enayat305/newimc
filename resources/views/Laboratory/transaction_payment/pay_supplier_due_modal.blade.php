<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('Lab\TransactionPaymentController@postPayContactDue'), 'method' => 'post', 'id' => 'pay_contact_due_form', 'files' => true ]) !!}
    ...
    <div class="modal-body">
      <div class="row">
        ...
        @elseif(in_array($due_payment_type, ['lab_sell']))
          <div class="col-md-6">
            <div class="well">
         ...
         @elseif(in_array($due_payment_type, ['lab_sell_return']))
         <div class="col-md-6">
          <div class="well">
            <strong>@lang('sale.customer_name'): </strong>{{ $contact_details->name }}<br>
              <br><br>
