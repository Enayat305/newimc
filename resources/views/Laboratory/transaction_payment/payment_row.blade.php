<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('Lab\TransactionPaymentController@store'), 'method' => 'post', 'id' => 'transaction_payment_add_form', 'files' => true ]) !!}
    ...
    <div class="modal-body">
      ...
      @if(!empty($transaction->contact))
        ...
        <div class="col-md-4">
          <div class="well">
          @if(in_array($transaction->type, ['lab_sell', 'lab_sell_return']))
      ...
      <div class="row payment_row">
        ...
        <div class="clearfix"></div>
          @include('Laboratory/transaction_payment.payment_type_details')
        <div class="col-md-12">
          <div class="form-group">
