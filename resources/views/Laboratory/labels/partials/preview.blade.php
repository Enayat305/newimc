...
@foreach($product_details as $details)
	...
	@endif
				...
				<b style=" display: block;font-size:10px">
					{{$details['details']->contact->name}}
					<br>
					{{$details['details']->tests->test_code}}
				
				</b>
			@endif

			<img class="center-block" style="width:90%; !important;height: 10mm !important;" src="data:image/png;base64,{{DNS1D::getBarcodePNG($details['details']->report_code, 'C128', 1,50,array(39, 48, 54), true)}}">
		</div>
	</div>
		@php
