...
<section class="content no-print">
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('Add test to generate Labels')])
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					<thead>
						<tr>
							<th class="col-sm-8">Tests</th>
							<th class="col-sm-4">@lang( 'barcode.no_of_labels' )</th>
						</tr>
					</thead>
					<tbody>
						@include('Laboratory/labels.partials.show_table_rows', ['index' => 0])
					</tbody>
				</table>
			</div>
		</div>
	...
	@component('components.widget', ['class' => 'box-primary', 'hidden','title' => __( 'barcode.info_in_labels' )])
		<div class="row" >
			...
			<div class="col-sm-3" id="price_type_div" hidden>
...
@stop
@section('javascript')
	<script src="{{ asset('js/lablabels.js?v=' . $asset_v) }}"></script>
@endsection
