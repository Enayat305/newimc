              ...
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'sales_representative_filter_form' ]) !!}
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('sr_business_id', $business_locations, 2, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
                    </div>
                </div>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="sr_sales_tab">
                        @include('Laboratory/report.partials.sales_representative_sales')
                    </div>

                    <div class="tab-pane" id="sr_commission_tab">
                        @include('Laboratory/report.partials.sales_representative_commission')
                    </div>

                    <div class="tab-pane" id="sr_expenses_tab">
                        @include('Laboratory/report.partials.sales_representative_expenses')
                    </div>
                </div>
