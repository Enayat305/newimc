            ...
            @component('components.filters', ['title' => __('report.filters')])
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('ssr_location_id', $business_locations, 2, ['class' => 'form-control select2', 'style' => 'width:100%']); !!}
                    </div>
                </div>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="ss_orders_tab">
                        @include('Laboratory/report.partials.service_staff_orders_table')
                    </div>

                    <div class="tab-pane" id="ss_line_orders_tab">
                        @include('Laboratory/report.partials.service_staff_line_orders_table')
                    </div>
                </div>
            </div>
        </div>
