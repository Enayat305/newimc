...
<div class="row">
    <div class="col-md-12">
        <div class="col-sm-3">
            @include('Laboratory/contact.contact_basic_info')
        </div>
        <div class="col-sm-3">
            @include('Laboratory/contact.contact_more_info')
        </div>
        @if( $contact->type != 'customer')
            <div class="col-sm-3">
                @include('Laboratory/contact.contact_tax_info')
            </div>
        @endif
        <div class="col-sm-3">
            @include('Laboratory/contact.contact_payment_info')
        </div>
        @if($reward_enabled)
