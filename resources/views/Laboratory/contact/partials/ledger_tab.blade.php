...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="col-md-9 text-right">
            <button data-href="{{action('Lab\ContactController@getLedger')}}?contact_id={{$contact->id}}&action=pdf" class="btn btn-default btn-xs" id="print_ledger_pdf"><i class="fas fa-file-pdf"></i></button>
