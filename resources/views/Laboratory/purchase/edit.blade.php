...
<section class="content">
  ...
  {!! Form::open(['url' =>  action('Lab\PurchaseController@update' , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]) !!}
  ...
  <input type="hidden" id="purchase_id" value="{{ $purchase->id }}">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="row">
            <div class="col-sm-12">
              @include('Laboratory/purchase.partials.edit_purchase_entry_row')
