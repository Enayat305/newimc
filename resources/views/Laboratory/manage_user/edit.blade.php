...
<section class="content">
    {!! Form::open(['url' => action('Lab\ManageUserController@update', [$user->id]), 'method' => 'PUT', 'id' => 'user_edit_form' ]) !!}
    <div class="row">
        <div class="col-md-12">
        ...
        @component('components.widget', ['title' => __('lang_v1.roles_and_permissions')])
            ...
            <div class="form-group col-md-6">
              ...
              {!! Form::select('type', ['doctor' => __('Doctor'), 'employee' => __('Employee'), 'others' => __('lang_v1.others')], !empty($user->type) ? $user->type : null, ['class' => 'form-control', 'id' => 'type', 'placeholder' => __( 'messages.please_select') ]); !!}
          </div>
            <div class="clearfix"></div>
            <div class="col-md-3">
        ...
        <div class="col-md-12">
            ...
            <div class="col-sm-4 ">
              <div class="form-group">
                  {!! Form::label('custom_field_1', __('Link Payment Account') . ':') !!}
                  <div class="form-group">
                      {!! Form::select('custom_field_1', $accounts, !empty($user->custom_field_1) ? $user->custom_field_1 : null, ['class' => 'form-control select2', 'multiple', 'style' => 'width: 100%;' ]); !!}
                  </div>
              </div>
          </div>
            @endcomponent
    ...
    @include('Laboratory/user.edit_profile_form_part', ['bank_details' => !empty($user->bank_details) ? json_decode($user->bank_details, true) : null])
