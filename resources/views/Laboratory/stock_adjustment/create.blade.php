...
<section class="content no-print">
	{!! Form::open(['url' => action('Lab\StockAdjustmentController@store'), 'method' => 'post', 'id' => 'stock_adjustment_form' ]) !!}
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						...
						{!! Form::select('location_id', $business_locations, 2, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
...
@stop
@section('javascript')
	<script src="{{ asset('js/labstock_adjustment.js?v=' . $asset_v) }}"></script>
@endsection
