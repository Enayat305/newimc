...
.table-responsive{
    ...
    <body>
		...
		<div id="invoice-top" style=" background-color: #e78200 !important;"  >
			<div class="logo" style="background-color: #3b6487 !important;">
  ...
  <div class="clearfix"></div>
  <div class="header" style=" background-color: #eee !important;  ">
	  <h6 style="float: left;"><b>Tset Result</b></h6>
...
@endif -->
	...
	<div class="header-bottom" style="border-top:solid #000;padding-left:35px;	font-size: 12px;">
		...
		<p style="font-size: 8px; ">Developed by Ayan softlimited Contact us:0342892305</p>
  </div>
