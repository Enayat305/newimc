$(document).ready(function() {
    ...
    supplier_report_tbl = $('#supplier_report_tbl').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '/lab/reports/customer-supplier',
            data: function(d) {
    ...
    register_report_table = $('#register_report_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/reports/register-report',
    ...
    stock_expiry_report_table = $('table#stock_expiry_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('button.stock_expiry_edit_btn').click(function() {
                ...
                $.ajax({
                    method: 'GET',
                    url: '/lab/reports/stock-expiry-edit-modal/' + purchase_line_id,
                    dataType: 'html',
    ...
    product_purchase_report = $('table#product_purchase_report_table').DataTable({
        ...
        ajax: {
            url: '/lab/reports/product-purchase-report',
            data: function(d) {
                var start = '';
                var end = '';
    ...
    if ($('#search_product').length > 0) {
        $('#search_product').autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: '/lab/purchases/get_products?check_enable_stock=false',
                    dataType: 'json',
                    data: {
                        term: request.term,
                    },
    ...
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        ajax: {
            url: '/lab/reports/product-sell-report',
            data: function(d) {
                var start = '';
                var end = '';
    ...
    product_sell_grouped_report = $('table#product_sell_grouped_report_table').DataTable({
        ...
        ajax: {
            url: '/lab/reports/product-sell-grouped-report',
            data: function(d) {
                var start = '';
                var end = '';
                if ($('#product_sr_date_filter').val()) {
    ...
    purchase_payment_report = $('table#purchase_payment_report_table').DataTable({
        ...
        ajax: {
            url: '/lab/reports/purchase-payment-report',
            data: function(d) {
                d.supplier_id = $('select#supplier_id').val();
                d.location_id = $('select#location_id').val();
                var start = '';
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        ajax: {
            url: '/lab/reports/sell-payment-report',
            data: function(d) {
...
function get_stock_details(rowData) {
    ...
    $.ajax({
        url: '/lab/reports/stock-details?location_id=' + location_id,
        data: {
...
function updateStockAdjustmentReport() {
    ...
    $.ajax({
        method: 'GET',
        url: '/lab/reports/stock-adjustment-report',
        dataType: 'json',
        data: data,
        success: function(data) {
...
function updateRegisterReport() {
    ...
    url_data = out.join('&');
    register_report_table.ajax.url('/lab/reports/register-report?' + url_data).load();
}
...
function salesRepresentativeTotalExpense() {
    ...
    $.ajax({
        method: 'GET',
        url: '/lab/reports/sales-representative-total-expense',
        dataType: 'json',
        data: data_expense,
        success: function(data) {
...
function salesRepresentativeTotalSales() {
    ...
    $.ajax({
        method: 'GET',
        url: '/lab/reports/sales-representative-total-sell',
        dataType: 'json',
        data: data_expense,
        success: function(data) {
...
function salesRepresentativeTotalCommission() {
    ...
    if (data_sell.commission_agent) {
        ...
        $.ajax({
            method: 'GET',
            url: '/lab/reports/sales-representative-total-commission',
            dataType: 'json',
            data: data_sell,
            success: function(data) {
                var str =
...
function show_child_payments(rowData) {
    var div = $('<div/>')
        ...
        .text('Loading...');
    $.ajax({
        url: '/lab/payments/show-child-payments/' + rowData.DT_RowId,
        dataType: 'html',
        success: function(data) {
            div.html(data).removeClass('loading');
            __currency_convert_recursively(div);
