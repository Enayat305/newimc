$(document).ready(function() {
    function myBooking(data) {
        var id = $("#t_" + data).text();
        document.getElementById("msg_c").innerHTML = "<div style=' padding-left:25px; color:green; font-size:20px;'>You Selected: " + id + "</div>";
    ...
    $(document).on('submit', 'form#allergie_add_form', function(e) {
        e.preventDefault();
        $(this)
    ...
    $(document).on('click', 'button.edit_allergie_button', function() {
        $('div.allergie_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#allergie_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_allergie_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_allergie,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    //Start: CRUD for diet
    //Diet table
    var diets_table = $('#diet_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/diets',
    ...
    $(document).on('submit', 'form#diet_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    $('div.diet_modal').modal('hide');
                    toastr.success(result.msg);
                    diets_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
                }
            },
    ...
    $(document).on('click', 'button.edit_diet_button', function() {
        $('div.diet_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#diet_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_diet_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_diet,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    //Start: CRUD for familyhistory
    //familyhistory table
    var familyhistory_table = $('#familyhistory_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/familyhistory',
        columnDefs: [{
            targets: 1,
            orderable: false,
            searchable: false,
    ...
    $(document).on('submit', 'form#familyhistory_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    $('div.familyhistory_modal').modal('hide');
                    toastr.success(result.msg);
                    familyhistory_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
                }
            },
    ...
    $(document).on('click', 'button.edit_familyhistory_button', function() {
        $('div.familyhistory_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#familyhistory_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_familyhistory_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_familyhistory,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    //Start: CRUD for Non Pathological History
    //Non Pathological History table
    var nonpathologicalhistory_table = $('#nonpathologicalhistory_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/nonpathologicalhistory',
        columnDefs: [{
            targets: 1,
            orderable: false,
            searchable: false,
    ...
    $(document).on('submit', 'form#nonpathologicalhistory_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    $('div.nonpathologicalhistory_modal').modal('hide');
                    toastr.success(result.msg);
                    nonpathologicalhistory_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
                }
            },
    ...
    $(document).on('click', 'button.edit_nonpathologicalhistory_button', function() {
        $('div.nonpathologicalhistory_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#nonpathologicalhistory_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_nonpathologicalhistory_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_nonpathologicalhistory,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    //Start: CRUD for  Pathological History
    // Pathological History table
    var pathologicalhistory_table = $('#pathologicalhistory_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/pathologicalhistory',
        columnDefs: [{
            targets: 1,
            orderable: false,
            searchable: false,
    ...
    $(document).on('submit', 'form#pathologicalhistory_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    $('div.pathologicalhistory_modal').modal('hide');
                    toastr.success(result.msg);
                    pathologicalhistory_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
                }
            },
    ...
    $(document).on('click', 'button.edit_pathologicalhistory_button', function() {
        $('div.pathologicalhistory_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#pathologicalhistory_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_pathologicalhistory_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_pathologicalhistory,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    //Start: CRUD for  Phychiatric History
    // Phychiatric History table
    var phychiatrichistory_table = $('#phychiatrichistory_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '/lab/phychiatrichistory',
        columnDefs: [{
            targets: 1,
            orderable: false,
            searchable: false,
    ...
    $(document).on('submit', 'form#phychiatrichistory_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.success == true) {
                    $('div.phychiatrichistory_modal').modal('hide');
                    toastr.success(result.msg);
                    phychiatrichistory_table.ajax.reload();
                } else {
                    toastr.error(result.msg);
                }
            },
    ...
    $(document).on('click', 'button.edit_phychiatrichistory_button', function() {
        $('div.phychiatrichistory_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#phychiatrichistory_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_phychiatrichistory_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_phychiatrichistory,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    $(document).on('submit', 'form#vaccine_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
    ...
    $(document).on('click', 'button.edit_vaccine_button', function() {
        $('div.vaccine_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#vaccine_edit_form').submit(function(e) {
                e.preventDefault();
                $(this)
                    .find('button[type="submit"]')
                    .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_vaccine_button', function() {
        swal({
            title: LANG.sure,
            text: LANG.confirm_delete_vaccine,
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
    ...
    var patient_table = $('#patient_table').DataTable({
        ...
        columns: [
            ...
            { data: 'age', name: 'age' },
            { data: 'marital_status', name: 'martial_status', searchable: false, orderable: false },
            { data: 'blood_group', name: 'blood_group', searchable: false, orderable: false },
    ...
    $('.patient_modal').on('shown.bs.modal', function(e) {
        ...
        $('form#patient_add_form, form#patient_edit_form')
            .submit(function(e) {
                e.preventDefault();
            })
            .validate({
                ...
                messages: {
                    contact_id: {
                        remote: 'Patient Id already exists',
                    },
                },
    ...
    $(document).on('click', '.edit_patient_button', function(e) {
        ...
        e.preventDefault();
        $('div.patient_modal').load($(this).attr('href'), function() {
            $(this).modal('show');
        });
    });

    $(document).on('click', '.delete_patient_button', function(e) {
        e.preventDefault();
        swal({
            title: LANG.sure,
    ...
    $(document).on('submit', 'form#transport_add_form', function(e) {
        e.preventDefault();
        $(this)
            .find('button[type="submit"]')
            .attr('disabled', true);
    ...
    $(document).on('click', 'button.delete_transport_button', function() {
        swal({
            title: LANG.sure,
            text: 'This transport company will be deleted',
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
...
$(document).on('hide.bs.modal', '.view_modal', function(e) {
    if ($(this).find('#email_body').length) {
...
$(document).on('hide.bs.modal', '.quick_add_product_modal', function(e) {
