...
class LabelsController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $products = [];
        if ($purchase_id) {
            $prod = Transaction::where('id', $purchase_id)
            ->first();
            
            $products = TestSell::where('transaction_id', $prod->id)
        ...
        return view('Laboratory/labels.show')
    ...
    public function preview(Request $request)
    {
        ...
        //try {
            ...
            foreach ($products as $value) {
                $details = TestSell::where('id', $value['variation_id'])
            ...
            $output = view('Laboratory/labels.partials.preview')
