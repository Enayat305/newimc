...
class ExpenseController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $expenses = Transaction::leftJoin('expense_categories AS ec', 'transactions.expense_category_id', '=', 'ec.id')
                        ...
                        ->where('transactions.type', 'lab_expense')
                        ->select(
                            'transactions.id',
            ...
            return Datatables::of($expenses)
                ->addColumn(
                    ...
                    <li><a href="{{action(\'Lab\\ExpenseController@edit\', [$id])}}"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</a></li>
                    @if($document)
                    ...
                    @endif
                    <li>
                        <a data-href="{{action(\'Lab\\ExpenseController@destroy\', [$id])}}" class="delete_expense"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</a></li>
                    <li class="divider"></li> 
                ...
                ->editColumn(
                    'payment_status',
                    '<a href="{{ action("Lab\\TransactionPaymentController@show", [$id])}}" class="view_payment_modal payment-status no-print" data-orig-value="{{$payment_status}}" data-status-name="{{__(\'lang_v1.\' . $payment_status)}}"><span class="label @payment_status($payment_status)">{{__(\'lang_v1.\' . $payment_status)}}
        ...
        return view('Laboratory/expense.index')
    ...
    public function create()
    {
        ...
        return view('Laboratory/expense.create')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data['type'] = 'lab_expense';
        ...
        return redirect()->action('Lab\ExpenseController@index')->with('status', $output);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Laboratory/expense.edit')
