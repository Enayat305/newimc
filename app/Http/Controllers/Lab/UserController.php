...
class UserController extends Controller
{
    ...
    */
    ...
    public function getProfile()
    {
        ...
        return view('Laboratory/user.profile', compact('user', 'languages'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            $user_id = $request->session()->get('user.id');
            $input = $request->only(['surname','type','first_name','type' ,'last_name', 'email', 'language', 'marital_status',
        ...
        return redirect('Lab/user/profile')->with('status', $output);
    }
