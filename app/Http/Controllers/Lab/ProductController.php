...
class ProductController extends Controller
{
    ...
    public function index()
    {
                ...
                ->addColumn(
                    ...
                    function ($row) use ($selling_price_group_count) {
                        ...
                        if (auth()->user()->can('lab_product.view')) {
                            $html .=
                            '<li><a href="' . action('Lab\ProductController@view', [$row->id]) . '" class="view-product"><i class="fa fa-eye"></i> ' . __("messages.view") . '</a></li>';
                        }

                        if (auth()->user()->can('lab_product.update')) {
                            $html .=
                            '<li><a href="' . action('Lab\ProductController@edit', [$row->id]) . '"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</a></li>';
                        }

                        if (auth()->user()->can('lab_product.delete')) {
                            $html .=
                            '<li><a href="' . action('Lab\ProductController@destroy', [$row->id]) . '" class="delete-product"><i class="fa fa-trash"></i> ' . __("messages.delete") . '</a></li>';
                        }

                        if ($row->is_inactive == 1) {
                            $html .=
                            '<li><a href="' . action('Lab\ProductController@activate', [$row->id]) . '" class="activate-product"><i class="fa fa-circle-o"></i> ' . __("lang_v1.reactivate") . '</a></li>';
                        }
                        ...
                        if (auth()->user()->can('lab_product.create')) {
                            ...
                            if ($selling_price_group_count > 0) {
                                $html .=
                                '<li><a href="' . action('Lab\ProductController@addSellingPrices', [$row->id]) . '"><i class="fas fa-money-bill-alt"></i> ' . __("lang_v1.add_selling_price_group_prices") . '</a></li>';
                            }

                            $html .=
                                '<li><a href="' . action('Lab\ProductController@create', ["d" => $row->id]) . '"><i class="fa fa-copy"></i> ' . __("lang_v1.duplicate_product") . '</a></li>';
                        }
                ...
                ->setRowAttr([
                    'data-href' => function ($row) {
                        if (auth()->user()->can("product.view")) {
                            return  action('Lab\ProductController@view', [$row->id]) ;
                        } else {
                            return '';
                        }
                    }])
        ...
        return view('Laboratory/product.index')
            ->with(compact(
                'rack_enabled',
                'categories',
                'brands',
    ...
    public function create()
    {
        ...
        return view('Laboratory/product.create')
    ...
    public function store(Request $request)
    {
        ...
        if ($request->input('submit_type') == 'submit_n_add_opening_stock') {
            ...
            return redirect()->action(
                'Lab\ProductController@addSellingPrices',
                [$product->id]
            );
        } elseif ($request->input('submit_type') == 'save_n_add_another') {
            return redirect()->action(
                'Lab\ProductController@create'
            )->with('status', $output);
        }

        
        return redirect()->action(
            'Lab\ProductController@index'
        )->with('status', $output);
    }
    ...
    public function show($id)
    {
        ...
        return view('Laboratory/product.show')->with(compact('details'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Laboratory/product.edit')
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->action('Lab\ProductController@index')->with('status', $output);
    }
    ...
    public function getProductVariationFormPart(Request $request)
    {
        ...
        if ($request->input('action') == "add") {
            ...
            if ($request->input('type') == 'single') {
                ...
                return view('Laboratory/product.partials.edit_single_product_form_part')
                            ->with(compact('product_deatails', 'action'));
            } elseif ($request->input('type') == 'variable') {
                $product_variations = ProductVariation::where('product_id', $product_id)
                        ->with(['variations', 'variations.media'])
                        ->get();
                return view('Laboratory/product.partials.variable_product_form_part')
                ...
                return view('Laboratory/product.partials.combo_product_form_part')
    ...
    public function getVariationValueRow(Request $request)
    {
        ...
        return view('Laboratory/product.partials.variation_value_row')
    ...
    public function getProductVariationRow(Request $request)
    {
        ...
        return view('Laboratory/product.partials.product_variation_row')
    ...
    public function getVariationTemplate(Request $request)
    {
        ...
        return view('Laboratory/product.partials.product_variation_template')
    ...
    public function getComboProductEntryRow(Request $request)
    {
        if (request()->ajax()) {
            ...
            if (!empty($product_id)) {
                ...
                return view('Laboratory/product.partials.combo_product_entry_row')
    ...
    public function quickAdd()
    {
        ...
        $locations = BusinessLocation::labforDropdown($business_id);
        ...
        return view('Laboratory/product.partials.quick_add_product')
    ...
    public function view($id)
    {
        ...
        foreach ($price_groups as $key => $value) {
            if (auth()->user()->can('lab_selling_price_group.' . $key)) {
        ...
        return view('Laboratory/product.view-modal')->with(compact(
            'product',
            'rack_details',
            'allowed_group_prices',
            'group_price_details',
    ...
    public function addSellingPrices($id)
    {
        ...
        return view('Laboratory/product.add-selling-prices')->with(compact('product', 'price_groups', 'variation_prices'));
    }
    ...
    public function viewGroupPrice($id)
    {
        ...
        return view('Laboratory/product.view-product-group-prices')->with(compact('product', 'allowed_group_prices', 'group_price_details'));
    }
    ...
    public function bulkEdit(Request $request)
    {
        ...
        if (!empty($selected_products_string)) {
            ...
            return view('Laboratory/product.bulk-edit')->with(compact(
                'products',
                'categories',
                'brands',
                'taxes',
    ...
    public function getProductToEdit($product_id)
    {
        ...
        return view('Laboratory/product.partials.bulk_edit_product_row')->with(compact(
            'product',
            'categories',
            'brands',
            'taxes',
