...
class RoleController extends Controller
{
    ...
    public function index()
    {
            ...
            return DataTables::of($roles)
                ->addColumn('action', function ($row) {
                    if (!$row->is_default || $row->name == "Cashier#" . $row->business_id) {
                        $action = '';
                        if (auth()->user()->can('lab_roles.update')) {
                            $action .= '<a href="' . action('Lab\RoleController@edit', [$row->id]) . '" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-edit"></i> ' . __("messages.edit") . '</a>';
                        }
                        if (auth()->user()->can('lab_roles.delete')) {
                            $action .= '&nbsp
                                <button data-href="' . action('Lab\RoleController@destroy', [$row->id]) . '" class="btn btn-xs btn-danger delete_role_button"><i class="glyphicon glyphicon-trash"></i> ' . __("messages.delete") . '</button>';
                        }
        ...
        return view('Laboratory/role.index');
    }
    ...
    {
        if (!auth()->user()->can('lab_roles.create')) {
            abort(403, 'Unauthorized action.');
        }
        ...
        return view('Laboratory/role.create')
    ...
    public function store(Request $request)
    {
        ...
        return redirect('lab/roles')->with('status', $output);
    }
    ...
    public function edit($id)
    {
        ...
        return view('Laboratory/role.edit')
