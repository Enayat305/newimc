...
class UnitController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($unit)
                ->addColumn(
                    'action',
                    '@can("lab_unit.update")
                    <button data-href="{{action(\'Lab\\UnitController@edit\', [$id])}}" class="btn btn-xs btn-primary edit_unit_button"><i class="glyphicon glyphicon-edit"></i> @lang("messages.edit")</button>
                        &nbsp;
                    @endcan
                    @can("lab_unit.delete")
                        <button data-href="{{action(\'Lab\\UnitController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_unit_button"><i class="glyphicon glyphicon-trash"></i> @lang("messages.delete")</button>
                    @endcan'
                )
        ...
        return view('Laboratory/unit.index');
    }
    ...
    {
        if (!auth()->user()->can('lab_unit.create')) {
            abort(403, 'Unauthorized action.');
        }
        ...
        return view('Laboratory/unit.create')
    ...
    {
        if (!auth()->user()->can('lab_unit.update')) {
            abort(403, 'Unauthorized action.');
        }
        ...
        if (request()->ajax()) {
            ...
            return view('Laboratory/unit.edit')
    ...
    {
        if (!auth()->user()->can('lab_unit.delete')) {
            abort(403, 'Unauthorized action.');
        }
