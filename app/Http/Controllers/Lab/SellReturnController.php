...
class SellReturnController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($sells)
                ...
                ->editColumn(
                    'payment_status',
                    '<a href="{{ action("Lab\TransactionPaymentController@show", [$id])}}" class="view_payment_modal payment-status payment-status-label" data-orig-value="{{$payment_status}}" data-status-name="{{__(\'lang_v1.\' . $payment_status)}}"><span class="label @payment_status($payment_status)">{{__(\'lang_v1.\' . $payment_status)}}</span></a>'
                )
        ...
        return view('Laboratory/sell_return.index')->with(compact('business_locations', 'customers', 'sales_representative'));
    }
    ...
    public function add($id)
    {
        ...
        $sell = Transaction::where('business_id', $business_id)
                            ->with(['test_sell','test_sell.tests','sell_lines', 'location', 'return_parent', 'contact', 'tax', 'sell_lines.sub_unit', 'sell_lines.product', 'sell_lines.product.unit'])
                            ->find($id);
        ...
        return view('Laboratory/sell_return.add')
            ->with(compact('sell'));
    }
