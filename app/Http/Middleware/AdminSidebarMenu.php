...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            $menu->url(action('Lab\HomeController@index'), __('DDC LABORATORY'), ['icon' => 'fa fas fa-tachometer-alt', 'active' => request()->segment(1) == 'home'])->order(5);
        ...
        // $moduleUtil->getModuleData('modifyAPdminMenu');
