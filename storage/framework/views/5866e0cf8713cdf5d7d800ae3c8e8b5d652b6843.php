    ...
    <?php $__env->startComponent('components.filters', ['title' => __('report.filters')]); ?>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <?php echo Form::select('type', ['single' => __('lang_v1.single'), 'variable' => __('lang_v1.variable')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_type', 'placeholder' => __('lang_v1.all')]);; ?>
        ...
        <div class="col-md-3" id="location_filter">
            <div class="form-group">
                ...
                <?php echo Form::select('location_id', $business_locations, 2, ['class' => 'form-control select2', 'style' => 'width:100%']);; ?>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lab_product.view')): ?>
    <div class="row">
        <div class="col-md-12">
           <!-- Custom Tabs -->
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lab_product.create')): ?>
                            <a class="btn btn-primary pull-right" href="<?php echo e(action('Lab\ProductController@create'), false); ?>">
                                        <i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('messages.add'); ?></a>
                            <br><br>
                        <?php endif; ?>
                        <?php echo $__env->make('Laboratory/product.partials.product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
<?php echo $__env->make('Laboratory/product.partials.edit_product_location_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('javascript'); ?>
    <script src="<?php echo e(asset('js/labproduct.js?v=' . $asset_v), false); ?>"></script>
        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('lab_view_purchase_price')): ?>
