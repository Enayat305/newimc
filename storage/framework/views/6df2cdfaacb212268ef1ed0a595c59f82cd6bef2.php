...
<script src="<?php echo e(asset('js/labapp.js?v=' . $asset_v), false); ?>"></script>
...
<script src="<?php echo e(asset('js/lab.js?v=' . $asset_v), false); ?>"></script>
<!-- TODO -->
<?php if(file_exists(public_path('AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\newimc\resources\views/lab_layouts/partials/javascripts.blade.php ENDPATH**/ ?>